...
class InductorParams():
    def GUI(self):
        ...
        self.InductorParams.geometry('500x300')  # геометрия окна
        ...
        btn2.place(x=10, y=250)
        btn3 = Button(self.InductorParams, text="Внести данные", bg="green", fg="black", command=self.Insertdata)
