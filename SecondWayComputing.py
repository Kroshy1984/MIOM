...
if v == 1:
    if l1 / di < 1.0:
        ...
        fb = 5.0
        m9 = fb * math.pow((1 + (l1 + l3) * (l1 + l3) / di / di), 0.5) - 4.5 * math.pow(((1 + (l1 - l3) * (l1 - l3) / di / di), 0.5) * n1 * pow(10,-7))
        m8 = dr * dr * di / (l1 * l3)
        M_ind_zag = m9 * m8
    # end
    # 2:begin { РАЗДАЧА }
if v == 2:
    if l3 / dr < 1:
        ...
        fb = 5.0
        m9 = fb * math.pow((1 + (l1 + l3) * (l1 + l3) / dr / dr), 0.5) - 4.5 * math.pow((1 + (l1 - l3) * (l1 - l3) / dr / dr), 0.5) * n1 * pow(10,-7))
        m8 = dr * di * di / (l3 * l1)
        M_ind_zag = m8 * m9
    # End{case}
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
