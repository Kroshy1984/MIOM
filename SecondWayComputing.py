...
def difur():
    ...
    print()
    if (poisk == 1) or (mmm == 0):
        k0 = 0.02*3.14*math.sqrt(1.0+alfa1)*math.sqrt(lw*c0)
        print("Рекомендуемый ШАГ счета ===&gt; &#39;"+str(k0*1e6)+"&#39; [ мкс]&#39;")
        print("&#39; Задайте шаг, [мкс] ==&gt; &#39;")
        k0=int(input())
        print ("&#39; ЗАДАЙТЕ КРАТНОСТЬ ШАГА ПЕЧАТИ ==&gt; &#39;")
        NS=input()
    Time_h = k0/(math.sqrt(lw*c0)*1e6)
    NI = 0
    Time_x = 0
    w=[]
    y=[]
...
# # dr - РАСЧЕТНЫЙ ДИАМЕТР ЗАГОТОВКИ}
    ...
    # # заготовка средняя }
            ...
            vb = 0
            q0 = 1
        if l3 / dr > 1.0:  # : # заготовка длинная }
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    c9 = (1.0 / (c0 * ls) - s1 * s1)
    if c9 < 0 and flag > 1:
        print("Ку ку разряд апериодический")  # :
