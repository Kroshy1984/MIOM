...
class Basad():
    def GUI(self):
        ...
        self.Tree.column("Condenser_capasity", width=250, anchor=EditorMashins.tk.CENTER)
        self.Tree.column("Equipment_induct", width=230, anchor=EditorMashins.tk.CENTER)
        self.Tree.column("SccF", width=280, anchor=EditorMashins.tk.CENTER)
