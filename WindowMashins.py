...
class Basad():
    def GUI(self):
        ...
        self.Tree.column("Condenser_capasity", width=50, anchor=EditorMashins.tk.CENTER)
        self.Tree.column("Equipment_induct", width=50, anchor=EditorMashins.tk.CENTER)
        self.Tree.column("SccF", width=50, anchor=EditorMashins.tk.CENTER)
