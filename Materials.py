...
class Materials():
    ...
    def AddMaterial(self):
        ...
        self.SBasa2.geometry('300x700+800+300')
    ...
    def EditMaterial(self):
        ...
        label2 = Label(self.SBasa, text="Предел прочности", bg="lightgrey", fg="black")
        self.message_entry1 = Entry(self.SBasa, textvariable="")
        self.message_entry1.place(x=400, y=150)
        label3 = Label(self.SBasa, text="Предел текучести", bg="lightgrey", fg="black")
        self.message_entry2 = Entry(self.SBasa, textvariable="")
        self.message_entry2.place(x=400, y=250)
        label4 = Label(self.SBasa, text="Плотность", bg="lightgrey", fg="black")
        ...
        label7 = Label(self.SBasa, text="Удельное сопротивление", bg="lightgrey", fg="black")
