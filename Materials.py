...
class Materials():
    def __init__(self):
        ...
        self.Tree.column("Name_of_the_metalls", width=250, anchor=tk.CENTER)
        self.Tree.column("Tensile_strength", width=190, anchor=tk.CENTER)
        self.Tree.column("Yield_strength", width=250, anchor=tk.CENTER)
        self.Tree.column("Material_density", width=230, anchor=tk.CENTER)
        self.Tree.column("M_M", width=280, anchor=tk.CENTER)
        self.Tree.column("B", width=60, anchor=tk.CENTER)
        self.Tree.column("Specific_electric_resistance", width=50, anchor=tk.CENTER)
        self.Tree.column("The_coefficient_of_dynamic", width=50, anchor=tk.CENTER)
        self.Tree.column("Еhe_dynamic_modulus_hardening", width=50, anchor=tk.CENTER)
